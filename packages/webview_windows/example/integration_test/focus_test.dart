...
math.Point<int> _screenPoint(WidgetTester tester, Finder finder, int viewHwnd) {
...
void _typeText(String text) {
  for (final codeUnit in text.toUpperCase().codeUnits) {
    ...
    try {
      ...
      inputs[0].Anonymous.ki.wVk = codeUnit;

      inputs[1].type = INPUT_KEYBOARD;
      inputs[1].Anonymous.ki.wVk = codeUnit;
